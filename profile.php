...
//        print "";
        ...
        print "<form action = 'update.php' method='post'>
                Name: <input type='text' size='25' name='name' value = '{$row['Name']}'><br><br>
                    
                Address: <input type='text' size='25' name='address' value = '{$row['Address']}'><br><br>

                City: &nbsp&nbsp&nbsp&nbsp<input type='text' size='25' name='city' value = '{$row['City']}'><br><br>

                Phone: <input type='text' size='25' name='phone' value = '{$row['Phone']}'><br><br>

                Email: &nbsp<input type='text' size='25' name='email' value = '{$row['Email']}'><br><br>
