...
$phone = $_POST['phone'];
$email = $_POST['email'];
$mbody = "Thank you for your info!!";
$header = "From: htran@cis.fordham.edu\n";  
mail($email, 'Confirmation', $mbody, $header);
print "<h4>Thank you for your info. You will receive an email shortly.</h4>";
print "Name: $name<br>";
...
if($dbc = mysql_connect('host', 'hdoan', 'hdoanmysql'))
        ...
        $query = "insert into Persons2 (name, address, city) values('$name', '$address', '$city')";
        @mysql_query($query);
